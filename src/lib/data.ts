...
const CHAMPIONS_DATA: Omit<Champion, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  { name: 'Brand', title: 'el Llamado Vengativo', role: 'Support', tier: 'A', winRate: 50.8, pickRate: 4.9, banRate: 0.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    proPickRate: 3.8,
    runes: { primary: 'Brujería — Cometa Arcano', secondary: 'Dominación — Sabor a Sangre', shards: 'Adaptativo + Fuerza + Resistencia' },
  },
  { name: "K'Sante", title: 'el Orgullo de Nazumah', role: 'Top', tier: 'A', winRate: 49.8, pickRate: 5.1, banRate: 2.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    aiAnalysis: "K'Sante es un top laner versátil en Tier A (Mobalytics 26.8). Su R (All Out) lo transforma en un bruiser con resistencias masivas. Es una pick sólida en la mayoría de composiciones.\n\nEl build tank maximiza su supervivencia en teamfights. Jak'Sho + Resistencia Divina le da scaling infinito.\n\nConsejo principal: Abusa de tu all-in lvl 6 con R transform para kills garantizados.",
    proPickRate: 7.5,
  ...
  { name: 'Viego', title: 'el Rey Ruinado', role: 'Jungle', tier: 'B', winRate: 48.1, pickRate: 4.8, banRate: 2.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    aiAnalysis: 'Viego es un jungler competitivo en Tier B (Tapin 26.8). Su R (Heartbreaker) le permite poseer campeones enemigos eliminados, obteniendo un reset completo de habilidades. En teamfights prolongados puede chain 3-4 eliminaciones.\n\nEl build bruiser maximiza su supervivencia para chain resets. Eclipse le da el burst necesario para carries.\n\nConsejo principal: Busca eliminar carries enemigos en teamfights para activar tu R. Evita iniciar — espera bajas para entrar.',
    proPickRate: 6.8,
  ...
  { name: 'Nilah', title: 'la Alegría Desenfrenada', role: 'ADC', tier: 'S', winRate: 53.0, pickRate: 1.8, banRate: 1.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    aiAnalysis: 'Nilah es la ADC con el win rate más alto del meta 26.8 (53%+, Tier 1 Metabot + Blitz). Su W (Jubilant Veil) da shield AoE al team, su R (Apotheosis) es un pull masivo que cambia teamfights, y su E dash + water form la hace imposible de catchear.\n\nEl build crit maximiza su DPS. Es la ADC más fuerte cuando se combina con enchanters que amplifican su W.\n\nConsejo principal: Usa tu W para proteger a tu equipo en engages. Tu R es devastador en teamfights cerrados — busca posiciones amplias.',
    proPickRate: 1.8,
    runes: { primary: 'Precisión — Pies Veloces', secondary: 'Valor — Revitalizar', shards: 'Adaptativo + Velocidad + Resistencia' },
  },
  { name: 'Soraka', title: 'la Hija del Cruce Estelar', role: 'Support', tier: 'S', winRate: 52.0, pickRate: 3.0, banRate: 0.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    synergy: 'Nilah, Jinx, KogMaw — Hypercarries que necesitan protección',
  ...
  { name: 'Zyra', title: 'la Ascendiente de las Zarzas', role: 'Support', tier: 'S', winRate: 51.8, pickRate: 2.8, banRate: 0.4, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    aiAnalysis: 'Zyra es el soporte de daño con más control de zona del meta 26.8 (Tier 1 Metabot + Blitz). Su R (Stranglethorns) es un knockup AoE masivo, sus plantas generan daño sin riesgo, y su E (Grasping Roots) es un root que domina la poke lane.\n\nEl build AP maximiza su daño de plants. Morellonomicon + Rabadón la convierte en un carry secundario real.\n\nConsejo principal: Coloca plantas en los arbustos para daño invisible. En teamfights, busca R sobre 3+ enemigos para knockup masivo.',
    proPickRate: 2.8,
  ...
  { name: 'Garen', title: 'el Poder de Demacia', role: 'Top', tier: 'A', winRate: 51.3, pickRate: 7.2, banRate: 2.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    aiAnalysis: "Garen es un top laner extremadamente sólido que domina la fase de lanes con su sustain de pasiva. Su E (Judgment) con CD reducido le da presión constante, y el sistema de Villain lo hace más letal contra carries. Es una de las mejores picks anti-mage en top lane.\n\nEl build bruiser con Fuerza de la Trinidad maximiza daño y sustain. Su Q decimatadora escala con HP, haciéndolo más fuerte cuanto más items completa.\n\nConsejo principal: Abusa de tu pasiva entre trades para mantener vida full. Contra el Villain, usa R para ejecutar carries sin piedad.",
    proPickRate: 2.1,
    runes: {"primary":"Precisión — Conquistador","secondary":"Valor — Segunda Vida","shards":"Adaptativo + Velocidad + Resistencia"},
  },
  ...
  { name: 'Diana', title: 'el Desprecio de la Luna', role: 'Jungle', tier: 'S', winRate: 52.4, pickRate: 5.6, banRate: 2.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    aiAnalysis: 'Diana asciende a S-tier como el jungler AP burst más fuerte del meta 26.8 (PropelRC S+, Blitz.gg 51% WR). Su R (Moonfall) es un pull AoE devastador que puede teamwipe con follow-up correcto. Su Q+R combo es burst AP instantáneo, y su W shield le da tankiness para sobrevivir la jungla y los dives.\n\nEl build AP assassin maximiza su burst. Rabadon + Llamarada Sombría + Morellonomicon convierte su Q+R en un one-shot para carries.\n\nConsejo principal: Busca ganks post-6 con Q+R para burst instantáneo. En teamfights, entra con R para pull masivo y deja que tu equipo follow-up. Especialista en counter-jungle.',
    proPickRate: 5.2,
    runes: { primary: 'Brujería — Cometa Arcano', secondary: 'Dominación — Sabor a Sangre', shards: 'Adaptativo + Fuerza + Resistencia' },
  },
  ...
  { name: 'Volibear', title: 'la Tormenta Implacable', role: 'Top', tier: 'A', winRate: 47.9, pickRate: 3.8, banRate: 0.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    aiAnalysis: "Volibear es un top laner tank con engage devastador. Su E+Q flip lanza carries enemigos directamente a su equipo, su W (Frenzy) ejecuta objetivos con poca vida, y su passive shield lo hace imposible de diver early. Su capacidad de engage es una de las más fuertes del juego.\n\nEl build tank maximiza supervivencia y CC. Hidra Titánica + Fuerza de la Trinidad le da suficiente daño para no ser ignorado.\n\nConsejo principal: Usa Q+E para lanzar carries enemigos hacia tu equipo. Tu passive te da sustain en trades, así que abusa de él en lane.",
    proPickRate: 1.2,
    runes: {"primary":"Precisión — Conquistador","secondary":"Valor — Revitalizar","shards":"Adaptativo + Velocidad + Resistencia"},
  },
  ...
  { name: 'Rakan', title: 'el Encantador', role: 'Support', tier: 'A', winRate: 48.1, pickRate: 4.7, banRate: 0.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    aiAnalysis: "Rakan es el soporte más móvil del meta. Su W (Grand Entrance) es un engage AoE, su R (The Quickness) da knockup masivo, y su movilidad le hace imposible de atrapar. Es la pick perfecta para proteger ADCs con engages rápidos.\n\nEl build enchanter maximiza peel y utilidad. Redención + Convergencia de Zeke + Mikael le da todo lo que necesita.\n\nConsejo principal: Combina E → W → R para engages chain devastadores. Tu movilidad te permite reposicionar rápidamente en teamfights.",
    proPickRate: 2.8,
    runes: {"primary":"Valor — Guardián","secondary":"Brujería — Debilidad","shards":"Armadura + Fuerza + Resistencia"},
  },
  ...
  { name: 'Nidalee', title: 'la Cazadora Bestial', role: 'Jungle', tier: 'A', winRate: 46.5, pickRate: 2.3, banRate: 0.4, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    aiAnalysis: "Nidalee es la junglera con el mayor skill ceiling del juego. Su lanza (Q) en forma humana puede one-shot carries, su movilidad en forma cougar es imposible de atrapar, y su capacidad de counter jungle es devastadora. Es una pick de alto riesgo y alta recompensa.\n\nEl build AP maximiza su burst. Rabadon + Morellonomicon convierte su lanza en un proyectil letal.\n\nConsejo principal: Practica el acierto de lanzas constantemente. Una lanza bien lanzada en mid game puede cambiar el curso del juego. Tras nivel 6, roam con cougar form para maximizar presión.",
    proPickRate: 2,
    runes: {"primary":"Brujería — Cometa Arcano","secondary":"Dominación — Colección de Ojos","shards":"Adaptativo + Fuerza + Resistencia"},
  },
  { name: 'Braum', title: 'el Corazón de los Freljord', role: 'Support', tier: 'A', winRate: 46.8, pickRate: 2.5, banRate: 0.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    aiAnalysis: "Braum es el soporte peel por excelencia. Su E (Unbreakable) bloquea todos los proyectiles entrantes, su R (Glacial Fissure) es el mejor ultimate defensivo del juego, y su capacidad de peel es insuperable. Es la pick definitiva para proteger ADCs de poke y assassinos.\n\nEl build tank maximiza su supervivencia. Redención + Medallón de los Solari le da utilidad masiva.\n\nConsejo principal: Tu E puede bloquear habilidades devastadoras como el R de Jinx, el W de Caitlyn, y el R de Ezreal. Timing perfecto del E es decisivo.",
    proPickRate: 1.5,
    runes: {"primary":"Valor — Guardián","secondary":"Brujería — Debilidad","shards":"Armadura + Fuerza + Resistencia"},
  },
  ...
  { name: 'Yorick', title: 'el Pastor de Almas', role: 'Top', tier: 'B', winRate: 46.2, pickRate: 2.1, banRate: 0.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    aiAnalysis: "Yorick es el rey indiscutible del split push. Su Maiden of the Mist le da 2v1 lane sin esfuerzo, su wall crea zonas de muerte en fights, y su capacidad de split push es tan fuerte que necesita 2+ enemigos para detenerlo. Es la pick perfecta para estrategias de presión lateral.\n\nEl build split push maximiza su daño a torres y 1v1. Fuerza de la Trinidad + Eclipse le da suficiente daño para ganar duelos.\n\nConsejo principal: Split push constantemente y usa Maiden para crear presión insostenible. Solo únete a teamfights si tu equipo está perdiendo objetivamente.",
    proPickRate: 0.5,
    runes: {"primary":"Precisión — Conquistador","secondary":"Valor — Segunda Vida","shards":"Adaptativo + Velocidad + Resistencia"},
  },
  { name: 'Ivern', title: 'el Padre Verde', role: 'Jungle', tier: 'B', winRate: 45.8, pickRate: 1.5, banRate: 0.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    aiAnalysis: "Ivern es el jungler más único del juego. Su capacidad de counter jungle le permite robar camps sin riesgo, su escudo + speed boost da peel top tier, y Daisy (su bush pet) aporta CC en objective fights. Es un campeón de alto skill ceiling con un kit completamente distinto.\n\nEl build enchanter maximiza su utilidad de soporte. Redención + Convergencia de Zeke + Mikael le da todo lo que necesita.\n\nConsejo principal: Usa tu passive para compartir jungle camps con tu carry. Daisy es decisiva en Baron y Dragon fights. Counter jungle agresivamente para crear desventaja de gold.",
    proPickRate: 0.3,
  ...
  { name: 'Urgot', title: 'el Acorazado', role: 'Top', tier: 'B', winRate: 44.5, pickRate: 1.4, banRate: 0.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    counterPick: 'Teemo, Vayne, Quinn',
    synergy: 'Orianna, Wukong, Malphite',
    aiAnalysis: "Urgot es el top laner más intimidante del juego. Su R (Fear Beyond Death) ejecuta enemigos por debajo de un umbral de vida, su shotgun knees hacen daño masivo en melee, y su tankiness natural lo hace difícil de matar. Es especialista en anti-Dive y ejecutar carries.\n\nEl build bruiser maximiza sustain y daño. Fuerza de la Trinidad + Eclipse le da trading power en lane.\n\nConsejo principal: Tu R es un execute que no se puede prevenir. En teamfights, bajas la vida de carries y usa R para ejecutarlos públicamente. Tu pasiva de legs es devastador contra melee.",
    proPickRate: 0.6,
    runes: {"primary":"Precisión — Conquistador","secondary":"Valor — Segunda Vida","shards":"Adaptativo + Velocidad + Resistencia"},
  },
  ...
  { name: 'Draven', title: 'el Gladiador', role: 'ADC', tier: 'B', winRate: 49.8, pickRate: 5.2, banRate: 1.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    brokenThings: ['Q axe catch → más daño base del juego', 'Pasiva gold → snowball económico'],
  ...
  { name: 'Elise', title: 'la Reina Araña', role: 'Jungle', tier: 'B', winRate: 48.1, pickRate: 3.1, banRate: 0.6, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
  ...
  { name: 'Nautilus', title: 'el Titán de las Profundidades', role: 'Support', tier: 'A', winRate: 51.3, pickRate: 6.8, banRate: 1.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
