...
const CHAMPIONS_DATA: Omit<Champion, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  {
    name: 'Jinx', title: 'la Cañón Suelto', role: 'ADC', tier: 'S', winRate: 54.1, pickRate: 12.3, banRate: 5.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
  ...
  {
    name: 'Thresh', title: 'el Guardián de Cadenas', role: 'Support', tier: 'S', winRate: 51.9, pickRate: 15.2, banRate: 1.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
  ...
  {
    name: 'Darius', title: 'la Mano de Noxus', role: 'Top', tier: 'S', winRate: 53.5, pickRate: 7.8, banRate: 8.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
  ...
  {
    name: 'Ahri', title: 'el Zorro de Nueve Colas', role: 'Mid', tier: 'S', winRate: 53.2, pickRate: 8.1, banRate: 2.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
  ...
  {
    name: 'Caitlyn', title: 'el Sheriff de Piltover', role: 'ADC', tier: 'S', winRate: 52.5, pickRate: 9.6, banRate: 2.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
  ...
  { name: 'Nocturne', title: 'el Pesadilla Eterna', role: 'Jungle', tier: 'S', winRate: 52.8, pickRate: 7.1, banRate: 3.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
  ...
  { name: 'Blitzcrank', title: 'el Gran Golem de Vapor', role: 'Support', tier: 'S', winRate: 51.8, pickRate: 8.3, banRate: 2.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
  ...
  { name: 'Brand', title: 'el Llamas Vengativo', role: 'Support', tier: 'S', winRate: 52.5, pickRate: 6.8, banRate: 1.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
  ...
  { name: "K'Sante", title: 'el Orgullo de Nazumah', role: 'Top', tier: 'S', winRate: 51.5, pickRate: 7.2, banRate: 4.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
  ...
  { name: 'Viego', title: 'el Rey Ruinado', role: 'Jungle', tier: 'S', winRate: 51.2, pickRate: 6.5, banRate: 3.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
  ...
  // Tier A — Fuertes (ex-S: Master Yi, Lee Sin, Yasuo demoted en 26.8)
  ...
  { name: 'Garen', title: 'el Poder de Demacia', role: 'Top', tier: 'S', winRate: 53.2, pickRate: 8.5, banRate: 3.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
  ...
  { name: 'Katarina', title: 'la Hoja Siniestra', role: 'Mid', tier: 'S', winRate: 53.4, pickRate: 8.8, banRate: 4.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
  ...
  { name: 'Graves', title: 'el Proscrito', role: 'Jungle', tier: 'S', winRate: 52.1, pickRate: 6.2, banRate: 2.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
  ...
  { name: 'Diana', title: 'el Desprecio de la Luna', role: 'Jungle', tier: 'A', winRate: 50.2, pickRate: 4.8, banRate: 1.4, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
  ...
  { name: 'Ashe', title: 'la Arquera de Escarcha', role: 'ADC', tier: 'S', winRate: 52.8, pickRate: 9.5, banRate: 1.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
  ...
  { name: 'Malphite', title: 'el Monolito de Piedra', role: 'Top', tier: 'B', winRate: 48.5, pickRate: 3.5, banRate: 0.4, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
  ...
  { name: 'Nautilus', title: 'el Titán de las Profundidades', role: 'Support', tier: 'B', winRate: 49.5, pickRate: 5.7, banRate: 0.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
  ...
  { name: 'Kennen', title: 'el Corazón de la Tormenta', role: 'Top', tier: 'B', winRate: 47.2, pickRate: 2.8, banRate: 0.9, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
