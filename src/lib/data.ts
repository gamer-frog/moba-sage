...
const CHAMPIONS_DATA: Omit<Champion, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  },
  {
    ...
    proPickRate: 25.6,
    runes: { primary: 'Valor — Guardián', secondary: 'Brujería — Frailidad', shards: 'Armadura + Fuerza + Resistencia' },
  },
  {
  ...
  { name: 'Viego', title: 'el Rey Ruinado', role: 'Jungle', tier: 'B', winRate: 48.1, pickRate: 4.8, banRate: 2.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    builds: [{ name: 'Build Bruiser', items: 'Cosechador Nocturno → Eclipse → Hidra Titánica → Fuerza de la Trinidad → Botas de Mercurio', winRate: 51.5 }],
  ...
  { name: 'Ornn', title: 'el Fuego del Monte', role: 'Top', tier: 'S', winRate: 52.1, pickRate: 2.4, banRate: 0.9, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    proPickRate: 4.2,
    runes: { primary: 'Valor — Guardián', secondary: 'Brujería — Frailidad', shards: 'Armadura + Velocidad + Resistencia' },
  },
  { name: 'Briar', title: 'la Cache Excéntrica', role: 'Jungle', tier: 'S', winRate: 52.4, pickRate: 4.2, banRate: 2.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    builds: [{ name: 'Build Bruiser', items: 'Cosechador Nocturno → Eclipse → Hidra Titánica → Fuerza de la Trinidad → Botas de Mercurio', winRate: 52.8 }],
    counterPick: 'Nidalee, Elise, Lee Sin',
  ...
  { name: 'Morgana', title: 'la Caída', role: 'Support', tier: 'A', winRate: 50.5, pickRate: 8.8, banRate: 1.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    ...
    proPickRate: 6.2,
    runes: {"primary":"Brujería — Invocar Aery","secondary":"Valor — Frailidad","shards":"Adaptativo + Fuerza + Resistencia"},
  },
  ...
  { name: 'Rakan', title: 'el Encantador', role: 'Support', tier: 'A', winRate: 48.1, pickRate: 4.7, banRate: 0.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    brokenThings: ['W engage → pelea por ADC seguro', 'R AoE knockup → combo CC', 'Mobility → imposible to catch'],
  ...
  { name: 'Nidalee', title: 'la Cazadora Bestial', role: 'Jungle', tier: 'A', winRate: 46.5, pickRate: 2.3, banRate: 0.4, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    brokenThings: ['Spear → one-shot carries', 'Cougar mobility → imposible catch', 'Counter jungle → starves enemy'],
    ...
    aiAnalysis: "Nidalee es la junglera con el mayor skill ceiling del juego. Su lanza (Q) en forma humana puede one-shot carries, su mobility en forma cougar es imposible de catchear, y su capacidad de counter jungle es devastadora. Es una pick de alto riesgo y alta recompensa.\n\nEl build AP maximiza su burst. Rabadon + Morellonomicon convierte su lanza en un proyectil letal.\n\nConsejo principal: Practica el acierto de lanzas constantemente. Una lanza bien lanzada en mid game puede cambiar el curso del juego. Tras level 6, roam con cougar form para maximizar presión.",
    proPickRate: 2,
    runes: {"primary":"Brujería — Cometa Arcano","secondary":"Dominación — Colección de Ojos","shards":"Adaptativo + Fuerza + Resistencia"},
  },
  ...
  // Tier S — Dioses del Meta (Wild Rift)
  {
    ...
    builds: [
      ...
      { name: 'Build Sustained', items: 'Eclipse → Roca del Eclipse → Guardián Angel → Botas de Celeridad', winRate: 53.4 },
    ],
  ...
  },
  {
    ...
    builds: [
      ...
      { name: 'Build Full AD', items: 'Filo de la Noche → Eclipse → Roca del Eclipse → El Coleccionista → Botas de Celeridad', winRate: 51.7 },
    ],
  ...
  { name: 'Morgana', title: 'la Caída', role: 'Support', tier: 'A', winRate: 51.0, pickRate: 9.5, banRate: 1.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.8', game: 'WR',
    ...
    proPickRate: 5.5,
    runes: { primary: 'Brujería — Cometa Arcano', secondary: 'Valor — Frailidad', shards: 'Adaptativo + Fuerza + Resistencia' },
  },
...
const COMBOS_DATA: BrokenCombo[] = [
  ...
  { id: 7, name: 'Chain Engage', champions: ['Lee Sin', 'Ahri', 'Orianna'], description: 'Lee Sin insec → Ahri charm follow-up → Orianna R shockwave. Chain engage letal.', winRate: 55.8, game: 'LoL', difficulty: 'difícil' },
  ...
  { id: 10, name: 'Knockup Chain', champions: ['Yasuo', 'Taliyah', 'Lee Sin', 'Ahri'], description: '4 knockups/CC chain. Yasuo R se activa cada teamfight sin esfuerzo.', winRate: 53.7, game: 'LoL', difficulty: 'difícil' },
  ...
  { id: 12, name: 'Knockup Machine', champions: ['Yasuo', 'Taliyah', 'Ahri', 'Lee Sin', 'Braum'], description: '5 campeones con knockup/CC. Yasuo R en CD = teamwipe.', winRate: 54.1, game: 'LoL', difficulty: 'difícil' },
