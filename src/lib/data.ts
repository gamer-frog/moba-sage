...
const CHAMPIONS_DATA: Omit<Champion, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  {
    name: 'Master Yi', title: 'el Buscador de Wuju', role: 'Jungle', tier: 'S', winRate: 55.2, pickRate: 14.1, banRate: 12.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  {
    name: 'Jinx', title: 'la Cañón Suelto', role: 'ADC', tier: 'S', winRate: 54.1, pickRate: 12.3, banRate: 5.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  {
    name: 'Lee Sin', title: 'el Monje Ciego', role: 'Jungle', tier: 'S', winRate: 52.8, pickRate: 10.5, banRate: 6.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  {
    name: 'Thresh', title: 'el Guardián de Cadenas', role: 'Support', tier: 'S', winRate: 51.9, pickRate: 15.2, banRate: 1.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  {
    name: 'Darius', title: 'la Mano de Noxus', role: 'Top', tier: 'S', winRate: 53.5, pickRate: 7.8, banRate: 8.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  {
    name: 'Ahri', title: 'el Zorro de Nueve Colas', role: 'Mid', tier: 'S', winRate: 53.2, pickRate: 8.1, banRate: 2.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  {
    name: 'Yasuo', title: 'el Imperdonable', role: 'Mid', tier: 'S', winRate: 51.8, pickRate: 11.2, banRate: 4.7, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  {
    name: 'Caitlyn', title: 'el Sheriff de Piltover', role: 'ADC', tier: 'S', winRate: 52.5, pickRate: 9.6, banRate: 2.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  // Tier A — Fuertes
  { name: 'Orianna', title: 'la Dama de Relojería', role: 'Mid', tier: 'A', winRate: 51.2, pickRate: 6.3, banRate: 0.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Vi', title: 'el Ejecutor de Piltover', role: 'Jungle', tier: 'A', winRate: 50.8, pickRate: 5.2, banRate: 1.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Ezreal', title: 'el Explorador Pródigo', role: 'ADC', tier: 'A', winRate: 49.5, pickRate: 8.9, banRate: 0.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Lulu', title: 'la Hechicera Fada', role: 'Support', tier: 'A', winRate: 50.1, pickRate: 7.4, banRate: 0.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Garen', title: 'el Poder de Demacia', role: 'Top', tier: 'A', winRate: 51.5, pickRate: 6.7, banRate: 1.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Katarina', title: 'la Hoja Siniestra', role: 'Mid', tier: 'A', winRate: 50.3, pickRate: 7.1, banRate: 2.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Graves', title: 'el Proscrito', role: 'Jungle', tier: 'A', winRate: 49.8, pickRate: 4.5, banRate: 0.6, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Vayne', title: 'la Cazadora Nocturna', role: 'ADC', tier: 'A', winRate: 50.6, pickRate: 5.8, banRate: 0.4, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Leona', title: 'el Amanecer Radiante', role: 'Support', tier: 'A', winRate: 51.0, pickRate: 4.9, banRate: 0.7, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Renekton', title: 'el Carnicero de las Arenas', role: 'Top', tier: 'A', winRate: 50.4, pickRate: 5.6, banRate: 1.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Zed', title: 'el Maestro de Sombras', role: 'Mid', tier: 'A', winRate: 49.2, pickRate: 8.3, banRate: 3.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Amumu', title: 'la Momia Triste', role: 'Jungle', tier: 'A', winRate: 51.3, pickRate: 6.1, banRate: 0.9, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Jhin', title: 'el Virtuoso', role: 'ADC', tier: 'A', winRate: 51.7, pickRate: 7.2, banRate: 1.0, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Morgana', title: 'la Caída', role: 'Support', tier: 'A', winRate: 50.5, pickRate: 8.8, banRate: 1.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Camille', title: 'la Sombra de Acero', role: 'Top', tier: 'A', winRate: 49.9, pickRate: 5.1, banRate: 2.0, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Diana', title: 'el Desprecio de la Luna', role: 'Jungle', tier: 'A', winRate: 50.2, pickRate: 4.8, banRate: 1.4, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Lux', title: 'la Dama de la Luminosidad', role: 'Mid', tier: 'A', winRate: 48.5, pickRate: 9.2, banRate: 0.6, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Nami', title: 'la Invocadora de Mareas', role: 'Support', tier: 'A', winRate: 49.1, pickRate: 5.3, banRate: 0.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Wukong', title: 'el Rey Mono', role: 'Top', tier: 'A', winRate: 48.8, pickRate: 4.2, banRate: 0.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Volibear', title: 'la Tormenta Implacable', role: 'Top', tier: 'A', winRate: 47.9, pickRate: 3.8, banRate: 0.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Twisted Fate', title: 'el Maestro de Cartas', role: 'Mid', tier: 'A', winRate: 48.2, pickRate: 4.5, banRate: 1.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Ashe', title: 'la Arquera de Escarcha', role: 'ADC', tier: 'A', winRate: 49.3, pickRate: 6.4, banRate: 0.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Rakan', title: 'el Encantador', role: 'Support', tier: 'A', winRate: 48.1, pickRate: 4.7, banRate: 0.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Xin Zhao', title: 'el Senescal de Demacia', role: 'Jungle', tier: 'A', winRate: 48.7, pickRate: 3.9, banRate: 0.4, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Tristana', title: 'la Pistolera Yordle', role: 'ADC', tier: 'A', winRate: 48.9, pickRate: 5.1, banRate: 0.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Shen', title: 'el Ojo del Crepúsculo', role: 'Top', tier: 'A', winRate: 47.5, pickRate: 3.2, banRate: 0.7, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Syndra', title: 'la Soberana Oscura', role: 'Mid', tier: 'A', winRate: 47.8, pickRate: 4.1, banRate: 0.9, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Nidalee', title: 'la Cazadora Bestial', role: 'Jungle', tier: 'A', winRate: 46.5, pickRate: 2.3, banRate: 0.4, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Braum', title: 'el Corazón de los Freljord', role: 'Support', tier: 'A', winRate: 46.8, pickRate: 2.5, banRate: 0.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: "Vel'Koz", title: 'el Ojo del Vacío', role: 'Mid', tier: 'A', winRate: 46.0, pickRate: 1.9, banRate: 0.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Taliyah', title: 'la Tejedora de Piedras', role: 'Mid', tier: 'A', winRate: 46.3, pickRate: 2.0, banRate: 0.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  // Tier B — Jugables
  { name: 'Yorick', title: 'el Pastor de Almas', role: 'Top', tier: 'B', winRate: 46.2, pickRate: 2.1, banRate: 0.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Ivern', title: 'el Padre Verde', role: 'Jungle', tier: 'B', winRate: 45.8, pickRate: 1.5, banRate: 0.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Kalista', title: 'la Lanza de la Venganza', role: 'ADC', tier: 'B', winRate: 45.5, pickRate: 1.8, banRate: 0.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Mordekaiser', title: 'el Reveniente de Hierro', role: 'Top', tier: 'B', winRate: 45.2, pickRate: 2.7, banRate: 0.6, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Bard', title: 'el Cuidador Errante', role: 'Support', tier: 'B', winRate: 43.5, pickRate: 1.2, banRate: 0.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Skarner', title: 'el Vanguardia de Cristal', role: 'Jungle', tier: 'B', winRate: 44.1, pickRate: 0.8, banRate: 0.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Azir', title: 'el Emperador de las Arenas', role: 'Mid', tier: 'B', winRate: 43.8, pickRate: 1.0, banRate: 0.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Urgot', title: 'el Acorazado', role: 'Top', tier: 'B', winRate: 44.5, pickRate: 1.4, banRate: 0.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Malphite', title: 'el Monolito de Piedra', role: 'Top', tier: 'B', winRate: 48.5, pickRate: 3.5, banRate: 0.4, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Senna', title: 'la Redentora', role: 'Support', tier: 'B', winRate: 49.0, pickRate: 4.8, banRate: 0.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Draven', title: 'el Gladiador', role: 'ADC', tier: 'B', winRate: 49.8, pickRate: 5.2, banRate: 1.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Elise', title: 'la Araña de la Spin', role: 'Jungle', tier: 'B', winRate: 48.1, pickRate: 3.1, banRate: 0.6, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Nautilus', title: 'el Titán de las Profundidades', role: 'Support', tier: 'B', winRate: 49.5, pickRate: 5.7, banRate: 0.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Ekko', title: 'el Niño Prodigio', role: 'Jungle', tier: 'B', winRate: 47.8, pickRate: 4.2, banRate: 1.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
  ...
  { name: 'Kennen', title: 'el Corazón de la Tormenta', role: 'Top', tier: 'B', winRate: 47.2, pickRate: 2.8, banRate: 0.9, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '14.8', game: 'LoL',
