...
const CHAMPIONS_DATA: Omit<Champion, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  { name: 'Brand', title: 'el Llamas Vengativo', role: 'Support', tier: 'S', winRate: 52.2, pickRate: 4.9, banRate: 0.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.8', game: 'LoL',
    metaUpdated: true, metaSources: ['Blitz.gg', 'U.GG', 'Metabot'],
