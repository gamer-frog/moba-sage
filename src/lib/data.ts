...
const CHAMPIONS_DATA: Omit<Champion, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  {
    name: 'Master Yi', title: 'el Buscador de Wuju', role: 'Jungle', tier: 'S', winRate: 55.2, pickRate: 14.1, banRate: 12.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  {
    name: 'Jinx', title: 'la Cañón Suelto', role: 'ADC', tier: 'S', winRate: 54.1, pickRate: 12.3, banRate: 5.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  {
    name: 'Lee Sin', title: 'el Monje Ciego', role: 'Jungle', tier: 'S', winRate: 52.8, pickRate: 10.5, banRate: 6.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  {
    name: 'Thresh', title: 'el Guardián de Cadenas', role: 'Support', tier: 'S', winRate: 51.9, pickRate: 15.2, banRate: 1.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  {
    name: 'Darius', title: 'la Mano de Noxus', role: 'Top', tier: 'S', winRate: 53.5, pickRate: 7.8, banRate: 8.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  {
    name: 'Ahri', title: 'el Zorro de Nueve Colas', role: 'Mid', tier: 'S', winRate: 53.2, pickRate: 8.1, banRate: 2.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  {
    name: 'Yasuo', title: 'el Imperdonable', role: 'Mid', tier: 'S', winRate: 51.8, pickRate: 11.2, banRate: 4.7, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  {
    name: 'Caitlyn', title: 'el Sheriff de Piltover', role: 'ADC', tier: 'S', winRate: 52.5, pickRate: 9.6, banRate: 2.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  // Tier A — Fuertes
  { name: 'Orianna', title: 'la Dama de Relojería', role: 'Mid', tier: 'A', winRate: 51.2, pickRate: 6.3, banRate: 0.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Vi', title: 'el Ejecutor de Piltover', role: 'Jungle', tier: 'A', winRate: 50.8, pickRate: 5.2, banRate: 1.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Ezreal', title: 'el Explorador Pródigo', role: 'ADC', tier: 'A', winRate: 49.5, pickRate: 8.9, banRate: 0.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Lulu', title: 'la Hechicera Fada', role: 'Support', tier: 'A', winRate: 50.1, pickRate: 7.4, banRate: 0.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Garen', title: 'el Poder de Demacia', role: 'Top', tier: 'A', winRate: 51.5, pickRate: 6.7, banRate: 1.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Katarina', title: 'la Hoja Siniestra', role: 'Mid', tier: 'A', winRate: 50.3, pickRate: 7.1, banRate: 2.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Graves', title: 'el Proscrito', role: 'Jungle', tier: 'A', winRate: 49.8, pickRate: 4.5, banRate: 0.6, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Vayne', title: 'la Cazadora Nocturna', role: 'ADC', tier: 'A', winRate: 50.6, pickRate: 5.8, banRate: 0.4, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Leona', title: 'el Amanecer Radiante', role: 'Support', tier: 'A', winRate: 51.0, pickRate: 4.9, banRate: 0.7, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Renekton', title: 'el Carnicero de las Arenas', role: 'Top', tier: 'A', winRate: 50.4, pickRate: 5.6, banRate: 1.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Zed', title: 'el Maestro de Sombras', role: 'Mid', tier: 'A', winRate: 49.2, pickRate: 8.3, banRate: 3.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Amumu', title: 'la Momia Triste', role: 'Jungle', tier: 'A', winRate: 51.3, pickRate: 6.1, banRate: 0.9, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Jhin', title: 'el Virtuoso', role: 'ADC', tier: 'A', winRate: 51.7, pickRate: 7.2, banRate: 1.0, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Morgana', title: 'la Caída', role: 'Support', tier: 'A', winRate: 50.5, pickRate: 8.8, banRate: 1.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Camille', title: 'la Sombra de Acero', role: 'Top', tier: 'A', winRate: 49.9, pickRate: 5.1, banRate: 2.0, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Diana', title: 'el Desprecio de la Luna', role: 'Jungle', tier: 'A', winRate: 50.2, pickRate: 4.8, banRate: 1.4, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
    ...
    aiAnalysis: "Diana es una junglera asesina AP con engage devastador. Su R (Crescent Strike) es un dash AoE que puede iniciar teamfights instantáneamente. Su shield + burst le da trades favorables en la jungla, y su power spike en nivel 6 es uno de los más fuertes del juego.\n\nEl build AP assassin maximiza su burst. Rabadon + Llamasomo la convierte en una amenaza letal para carries.\n\nConsejo principal: Gank tras nivel 6 con Q → R para dash sorpresa. En teamfights, busca R sobre carries agrupados para máximo impacto.",
    proPickRate: 2.3,
    runes: {"primary":"Dominación — Electrocutar","secondary":"Precisión — Presencia de Campeón","shards":"Adaptativo + Fuerza + Resistencia"},
  },
  { name: 'Lux', title: 'la Dama de la Luminosidad', role: 'Mid', tier: 'A', winRate: 48.5, pickRate: 9.2, banRate: 0.6, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Nami', title: 'la Invocadora de Mareas', role: 'Support', tier: 'A', winRate: 49.1, pickRate: 5.3, banRate: 0.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Wukong', title: 'el Rey Mono', role: 'Top', tier: 'A', winRate: 48.8, pickRate: 4.2, banRate: 0.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Volibear', title: 'la Tormenta Implacable', role: 'Top', tier: 'A', winRate: 47.9, pickRate: 3.8, banRate: 0.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Twisted Fate', title: 'el Maestro de Cartas', role: 'Mid', tier: 'A', winRate: 48.2, pickRate: 4.5, banRate: 1.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Ashe', title: 'la Arquera de Escarcha', role: 'ADC', tier: 'A', winRate: 49.3, pickRate: 6.4, banRate: 0.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Rakan', title: 'el Encantador', role: 'Support', tier: 'A', winRate: 48.1, pickRate: 4.7, banRate: 0.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Xin Zhao', title: 'el Senescal de Demacia', role: 'Jungle', tier: 'A', winRate: 48.7, pickRate: 3.9, banRate: 0.4, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Tristana', title: 'la Pistolera Yordle', role: 'ADC', tier: 'A', winRate: 48.9, pickRate: 5.1, banRate: 0.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Shen', title: 'el Ojo del Crepúsculo', role: 'Top', tier: 'A', winRate: 47.5, pickRate: 3.2, banRate: 0.7, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Syndra', title: 'la Soberana Oscura', role: 'Mid', tier: 'A', winRate: 47.8, pickRate: 4.1, banRate: 0.9, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Nidalee', title: 'la Cazadora Bestial', role: 'Jungle', tier: 'A', winRate: 46.5, pickRate: 2.3, banRate: 0.4, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Braum', title: 'el Corazón de los Freljord', role: 'Support', tier: 'A', winRate: 46.8, pickRate: 2.5, banRate: 0.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: "Vel'Koz", title: 'el Ojo del Vacío', role: 'Mid', tier: 'A', winRate: 46.0, pickRate: 1.9, banRate: 0.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Taliyah', title: 'la Tejedora de Piedras', role: 'Mid', tier: 'A', winRate: 46.3, pickRate: 2.0, banRate: 0.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  // Tier B — Jugables
  { name: 'Yorick', title: 'el Pastor de Almas', role: 'Top', tier: 'B', winRate: 46.2, pickRate: 2.1, banRate: 0.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Ivern', title: 'el Padre Verde', role: 'Jungle', tier: 'B', winRate: 45.8, pickRate: 1.5, banRate: 0.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Kalista', title: 'la Lanza de la Venganza', role: 'ADC', tier: 'B', winRate: 45.5, pickRate: 1.8, banRate: 0.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Mordekaiser', title: 'el Reveniente de Hierro', role: 'Top', tier: 'B', winRate: 45.2, pickRate: 2.7, banRate: 0.6, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Bard', title: 'el Cuidador Errante', role: 'Support', tier: 'B', winRate: 43.5, pickRate: 1.2, banRate: 0.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Skarner', title: 'el Vanguardia de Cristal', role: 'Jungle', tier: 'B', winRate: 44.1, pickRate: 0.8, banRate: 0.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Azir', title: 'el Emperador de las Arenas', role: 'Mid', tier: 'B', winRate: 43.8, pickRate: 1.0, banRate: 0.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Urgot', title: 'el Acorazado', role: 'Top', tier: 'B', winRate: 44.5, pickRate: 1.4, banRate: 0.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Malphite', title: 'el Monolito de Piedra', role: 'Top', tier: 'B', winRate: 48.5, pickRate: 3.5, banRate: 0.4, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
    ...
    synergy: 'Orianna, Kennen, Wukong',
    aiAnalysis: "Malphite es el top laner con el mejor engage AoE del juego. Su R (Unstoppable Force) es un knockup masivo que puede teamwipe instantáneamente, y su E scaling con armadura lo hace impossible de lastimar en lane contra ADCs. Es la pick definitiva anti-AD y anti-teamfight.\n\nEl build tank maximiza su armor y CC. Fuerza de Trinidad + Resistencia Divina le da todo lo que necesita.\n\nConsejo principal: En contra de AD, conviértete en un tanque impossible de matar. Tu R es el mejor engage del juego, busca 3+ enemigos agrupados para team wipes.",
    proPickRate: 1.8,
    runes: {"primary":"Determinación — Guardián","secondary":"Brujería — Frailidad","shards":"Armadura + Velocidad + Resistencia"},
  },
  { name: 'Senna', title: 'la Redentora', role: 'Support', tier: 'B', winRate: 49.0, pickRate: 4.8, banRate: 0.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Draven', title: 'el Gladiador', role: 'ADC', tier: 'B', winRate: 49.8, pickRate: 5.2, banRate: 1.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Elise', title: 'la Araña de la Spin', role: 'Jungle', tier: 'B', winRate: 48.1, pickRate: 3.1, banRate: 0.6, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Nautilus', title: 'el Titán de las Profundidades', role: 'Support', tier: 'B', winRate: 49.5, pickRate: 5.7, banRate: 0.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
    ...
    counterPick: 'Morgana, Lux, Zyra',
    synergy: 'Jinx, Caitlyn, Ashe',
    aiAnalysis: "Nautilus es el soporte CC machine del meta. Su R (Depth Charge) es point-click con knockup, su Q (Dredge Line) es un hook masivo, y tiene 4 formas distintas de CC en su kit. Es la pick más consistente para engages garantizados.\n\nEl build tank maximiza su supervivencia para absorber daño. Redención + Medallón de los Solari le da utilidad masiva en teamfights.\n\nConsejo principal: Tu R es point-and-click → imposible fallar. Úsalo siempre sobre el carry enemigo más peligroso. Tu Q es un engage sorprendente desde los arbustos.",
    proPickRate: 2,
    runes: {"primary":"Determinación — Guardián","secondary":"Brujería — Frailidad","shards":"Armadura + Fuerza + Resistencia"},
  },
  { name: 'Ekko', title: 'el Niño Prodigio', role: 'Jungle', tier: 'B', winRate: 47.8, pickRate: 4.2, banRate: 1.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  { name: 'Kennen', title: 'el Corazón de la Tormenta', role: 'Top', tier: 'B', winRate: 47.2, pickRate: 2.8, banRate: 0.9, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '16.8', game: 'LoL',
  ...
  {
    name: 'Master Yi', title: 'el Buscador de Wuju', role: 'Jungle', tier: 'S', winRate: 56.8, pickRate: 16.3, banRate: 15.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
    brokenThings: ['Q resetea en kills → snowball infinito', 'Combo Yi+Taric invulnerable → sin interacción', 'Alpha Strike dodgea habilidades intargetable'],
    buildLinks: [{"label": "U.GG", "url": "https://u.gg/lol/champions/masteryi/build"}, {"label": "Mobalytics", "url": "https://www.mobalytics.com/lol/champions/masteryi"}, {"label": "OP.GG", "url": "https://www.op.gg/champions/masteryi"}],
    builds: [
  ...
  {
    name: 'Jinx', title: 'la Cañón Suelto', role: 'ADC', tier: 'S', winRate: 55.1, pickRate: 14.8, banRate: 6.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
    brokenThings: ['Pasiva 1 kill = limpia teamfight', 'W rango buff → poke sin respuesta', 'Kraken + Runaan = AoE masivo'],
    buildLinks: [{"label": "U.GG", "url": "https://u.gg/lol/champions/jinx/build"}, {"label": "Mobalytics", "url": "https://www.mobalytics.com/lol/champions/jinx"}, {"label": "OP.GG", "url": "https://www.op.gg/champions/jinx"}],
    builds: [
  ...
  {
    name: 'Lee Sin', title: 'el Monje Ciego', role: 'Jungle', tier: 'S', winRate: 53.5, pickRate: 12.1, banRate: 8.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
    brokenThings: ['Insec Q→R→Flash → pick sin counterplay', 'Pressure level 2-3 inigualable', 'Eclipse burst → mata carries en 1 combo'],
    buildLinks: [{"label": "U.GG", "url": "https://u.gg/lol/champions/leesin/build"}, {"label": "Mobalytics", "url": "https://www.mobalytics.com/lol/champions/leesin"}, {"label": "OP.GG", "url": "https://www.op.gg/champions/leesin"}],
    builds: [
  ...
  {
    name: 'Ahri', title: 'el Zorro de Nueve Colas', role: 'Mid', tier: 'S', winRate: 54.2, pickRate: 11.5, banRate: 4.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
    brokenThings: ['Charm range buff → landing fácil', 'R 3 cargas → roaming impredecible', 'One-shot Rabadon → elimina carries'],
    buildLinks: [{"label": "U.GG", "url": "https://u.gg/lol/champions/ahri/build"}, {"label": "Mobalytics", "url": "https://www.mobalytics.com/lol/champions/ahri"}, {"label": "OP.GG", "url": "https://www.op.gg/champions/ahri"}],
    builds: [
  ...
  {
    name: 'Darius', title: 'la Mano de Noxus', role: 'Top', tier: 'S', winRate: 54.5, pickRate: 9.8, banRate: 10.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
    brokenThings: ['Q heal + hemorragia → gana todos los trades', 'E anchor bajo torre → dive gratis', 'Ban rate 10%+ → nadie quiere facing'],
    buildLinks: [{"label": "U.GG", "url": "https://u.gg/lol/champions/darius/build"}, {"label": "Mobalytics", "url": "https://www.mobalytics.com/lol/champions/darius"}, {"label": "OP.GG", "url": "https://www.op.gg/champions/darius"}],
    builds: [
  ...
  {
    name: 'Thresh', title: 'el Guardián de Cadenas', role: 'Support', tier: 'S', winRate: 52.8, pickRate: 16.5, banRate: 2.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
    brokenThings: ['Lantern repositiona ADC sin riesgo', 'Engage + Peel en un kit → nunca mal pick', 'Pick rate 25%+ → siempre funciona'],
    buildLinks: [{"label": "U.GG", "url": "https://u.gg/lol/champions/thresh/build"}, {"label": "Mobalytics", "url": "https://www.mobalytics.com/lol/champions/thresh"}, {"label": "OP.GG", "url": "https://www.op.gg/champions/thresh"}],
    builds: [
  ...
  { name: 'Ezreal', title: 'el Explorador Pródigo', role: 'ADC', tier: 'A', winRate: 50.8, pickRate: 10.2, banRate: 0.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
    brokenThings: ['Q spam → nunca en peligro en lane', 'E escape → imposible de gankear', 'Blue build → damage sin riesgo'],
    buildLinks: [{"label": "U.GG", "url": "https://u.gg/lol/champions/ezreal/build"}, {"label": "Mobalytics", "url": "https://www.mobalytics.com/lol/champions/ezreal"}, {"label": "OP.GG", "url": "https://www.op.gg/champions/ezreal"}],
  ...
  { name: 'Zed', title: 'el Maestro de Sombras', role: 'Mid', tier: 'A', winRate: 50.3, pickRate: 9.1, banRate: 4.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
    buildLinks: [{"label": "U.GG", "url": "https://u.gg/lol/champions/zed/build"}, {"label": "Mobalytics", "url": "https://www.mobalytics.com/lol/champions/zed"}, {"label": "OP.GG", "url": "https://www.op.gg/champions/zed"}],
  ...
  { name: 'Garen', title: 'el Poder de Demacia', role: 'Top', tier: 'A', winRate: 52.1, pickRate: 8.3, banRate: 1.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
    brokenThings: ['E CD reducido → más spins más daño', 'Passive sustain → nunca backea', 'Villain → punish carries sin esfuerzo'],
    buildLinks: [{"label": "U.GG", "url": "https://u.gg/lol/champions/garen/build"}, {"label": "Mobalytics", "url": "https://www.mobalytics.com/lol/champions/garen"}, {"label": "OP.GG", "url": "https://www.op.gg/champions/garen"}],
  ...
  { name: 'Katarina', title: 'la Hoja Siniestra', role: 'Mid', tier: 'A', winRate: 50.6, pickRate: 7.8, banRate: 2.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
    buildLinks: [{"label": "U.GG", "url": "https://u.gg/lol/champions/katarina/build"}, {"label": "Mobalytics", "url": "https://www.mobalytics.com/lol/champions/katarina"}, {"label": "OP.GG", "url": "https://www.op.gg/champions/katarina"}],
  ...
  { name: 'Vi', title: 'el Ejecutor de Piltover', role: 'Jungle', tier: 'A', winRate: 51.5, pickRate: 6.8, banRate: 1.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
    brokenThings: ['R point-click → no se puede dodge', 'Eclipse bruiser → tanque y daño', 'Q gap closer → ganks lvl 2 garantizados'],
    buildLinks: [{"label": "U.GG", "url": "https://u.gg/lol/champions/vi/build"}, {"label": "Mobalytics", "url": "https://www.mobalytics.com/lol/champions/vi"}, {"label": "OP.GG", "url": "https://www.op.gg/champions/vi"}],
  ...
  { name: 'Lulu', title: 'la Hechicera Fada', role: 'Support', tier: 'A', winRate: 50.9, pickRate: 8.1, banRate: 0.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
    brokenThings: ['R peeling → protege carry completamente', 'W polymorph → shutdown carries', 'Meta estable → siempre relevante'],
    buildLinks: [{"label": "U.GG", "url": "https://u.gg/lol/champions/lulu/build"}, {"label": "Mobalytics", "url": "https://www.mobalytics.com/lol/champions/lulu"}, {"label": "OP.GG", "url": "https://www.op.gg/champions/lulu"}],
  ...
  { name: 'Vayne', title: 'la Cazadora Nocturna', role: 'ADC', tier: 'A', winRate: 51.2, pickRate: 5.5, banRate: 0.6, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
    brokenThings: ['W % true damage → mata tanks', 'Q tumble → impossible hit skillshots', 'R burst desde stealth'],
    buildLinks: [{"label": "U.GG", "url": "https://u.gg/lol/champions/vayne/build"}, {"label": "Mobalytics", "url": "https://www.mobalytics.com/lol/champions/vayne"}, {"label": "OP.GG", "url": "https://www.op.gg/champions/vayne"}],
  ...
  { name: 'Camille', title: 'la Sombra de Acero', role: 'Top', tier: 'A', winRate: 50.4, pickRate: 6.2, banRate: 2.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
    buildLinks: [{"label": "U.GG", "url": "https://u.gg/lol/champions/camille/build"}, {"label": "Mobalytics", "url": "https://www.mobalytics.com/lol/champions/camille"}, {"label": "OP.GG", "url": "https://www.op.gg/champions/camille"}],
    builds: [{ name: 'Build Bruiser', items: 'Cosechador Nocturno → Hidra Titánica → Fuerza de la Trinidad → Resistencia Divina → Botas de Mercurio', winRate: 50.5 }],
  ...
  { name: 'Graves', title: 'el Proscrito', role: 'Jungle', tier: 'A', winRate: 49.8, pickRate: 5.1, banRate: 0.8, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
  ...
  { name: 'Morgana', title: 'la Caída', role: 'Support', tier: 'A', winRate: 51.0, pickRate: 9.5, banRate: 1.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
    buildLinks: [{"label": "U.GG", "url": "https://u.gg/lol/champions/morgana/build"}, {"label": "Mobalytics", "url": "https://www.mobalytics.com/lol/champions/morgana"}, {"label": "OP.GG", "url": "https://www.op.gg/champions/morgana"}],
    builds: [{ name: 'Build AP', items: 'Morellonomicon → Sombrero de Rabadon → Reloj de Zhonya → Cetro de Rylai → Botas del Vacío', winRate: 50.8 }],
  ...
  { name: 'Jhin', title: 'el Virtuoso', role: 'ADC', tier: 'A', winRate: 52.0, pickRate: 7.8, banRate: 1.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
    brokenThings: ['R snipe teamwide → damage a distancia', 'Crit passive → burst 4to shot', 'W root + trampa = pick seguro'],
    buildLinks: [{"label": "U.GG", "url": "https://u.gg/lol/champions/jhin/build"}, {"label": "Mobalytics", "url": "https://www.mobalytics.com/lol/champions/jhin"}, {"label": "OP.GG", "url": "https://www.op.gg/champions/jhin"}],
  ...
  { name: 'Caitlyn', title: 'el Sheriff de Piltover', role: 'ADC', tier: 'B', winRate: 48.2, pickRate: 6.1, banRate: 0.9, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
...
const PRO_PICKS_DATA: Omit<ProPick, 'id'>[] = [
  { champion: 'Ahri', role: 'Mid', tournament: 'LCK', region: 'KR', pickRate: 18.5, banRate: 12.3, winRate: 56.2, patch: '16.8' },
  { champion: 'Jinx', role: 'ADC', tournament: 'LCK', region: 'KR', pickRate: 22.1, banRate: 8.5, winRate: 54.8, patch: '16.8' },
  { champion: 'Lee Sin', role: 'Jungle', tournament: 'LPL', region: 'CN', pickRate: 15.3, banRate: 18.2, winRate: 51.1, patch: '16.8' },
  { champion: 'Thresh', role: 'Support', tournament: 'LCK', region: 'KR', pickRate: 25.6, banRate: 3.1, winRate: 53.5, patch: '16.8' },
  { champion: 'Azir', role: 'Mid', tournament: 'LCK', region: 'KR', pickRate: 14.2, banRate: 22.5, winRate: 57.3, patch: '16.8' },
  { champion: 'Rakan', role: 'Support', tournament: 'LEC', region: 'EU', pickRate: 18.3, banRate: 5.2, winRate: 52.8, patch: '16.8' },
  { champion: 'Jhin', role: 'ADC', tournament: 'LEC', region: 'EU', pickRate: 16.8, banRate: 6.1, winRate: 51.9, patch: '16.8' },
  { champion: 'Camille', role: 'Top', tournament: 'LCK', region: 'KR', pickRate: 13.5, banRate: 20.1, winRate: 48.7, patch: '16.8' },
  { champion: 'Xin Zhao', role: 'Jungle', tournament: 'LCS', region: 'NA', pickRate: 11.2, banRate: 4.5, winRate: 49.3, patch: '16.8' },
  { champion: 'Orianna', role: 'Mid', tournament: 'LPL', region: 'CN', pickRate: 19.8, banRate: 15.3, winRate: 55.1, patch: '16.8' },
  { champion: 'Vayne', role: 'ADC', tournament: 'LCK', region: 'KR', pickRate: 8.5, banRate: 3.2, winRate: 58.9, patch: '16.8' },
  { champion: 'Maokai', role: 'Support', tournament: 'LCS', region: 'NA', pickRate: 14.1, banRate: 2.8, winRate: 53.2, patch: '16.8' },
  { champion: 'Darius', role: 'Top', tournament: 'LPL', region: 'CN', pickRate: 10.3, banRate: 12.8, winRate: 52.5, patch: '16.8' },
  { champion: 'Master Yi', role: 'Jungle', tournament: 'LCS', region: 'NA', pickRate: 5.2, banRate: 8.1, winRate: 45.3, patch: '16.8' },
  { champion: 'Caitlyn', role: 'ADC', tournament: 'LPL', region: 'CN', pickRate: 20.5, banRate: 9.3, winRate: 54.6, patch: '16.8' },
  { champion: 'Gwen', role: 'Top', tournament: 'LEC', region: 'EU', pickRate: 12.7, banRate: 16.5, winRate: 50.8, patch: '16.8' },
];
