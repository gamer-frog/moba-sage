...
const CHAMPIONS_DATA: Omit<Champion, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  { name: 'Garen', title: 'el Poder de Demacia', role: 'Top', tier: 'B', winRate: 48.0, pickRate: 5.5, banRate: 0.8, image: '', aiInsight: '', build: '', runes: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
    brokenThings: ['E CD reducido → más spins más daño', 'Passive sustain → nunca backea'],
    buildLinks: [{"label": "U.GG", "url": "https://u.gg/lol/champions/garen/build"}, {"label": "Mobalytics", "url": "https://www.mobalytics.com/lol/champions/garen"}, {"label": "OP.GG", "url": "https://www.op.gg/champions/garen"}],
    builds: [{ name: 'Build Bruiser', items: 'Fuerza de la Trinidad → Eclipse → Hidra Titánica → Resistencia Divina → Botas de Placas', winRate: 48.5 }],
  },
  { name: 'Lulu', title: 'la Hechicera Fada', role: 'Support', tier: 'B', winRate: 47.5, pickRate: 4.8, banRate: 0.4, image: '', aiInsight: '', build: '', runes: '', counters: '', synergies: '', patch: '6.4', game: 'WR',
    brokenThings: ['R peeling → protege carry completamente', 'W polymorph → shutdown carries'],
    buildLinks: [{"label": "U.GG", "url": "https://u.gg/lol/champions/lulu/build"}, {"label": "Mobalytics", "url": "https://www.mobalytics.com/lol/champions/lulu"}, {"label": "OP.GG", "url": "https://www.op.gg/champions/lulu"}],
    builds: [{ name: 'Build Enchanter', items: 'Redención → Convergencia de Zeke → Mikael → Medallón → Botas de CD', winRate: 48.0 }],
  },
