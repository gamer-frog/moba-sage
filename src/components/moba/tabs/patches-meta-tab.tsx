...
import {
  ...
  TrendingUp, TrendingDown, Minus, ArrowUp, ArrowDown, Zap, Target, Compass,
...
import { TinyChampionIcon, SplashArtIcon, ChampionIcon } from '../champion-icon';
