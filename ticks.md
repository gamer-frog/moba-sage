...
- [2026-04-22 04:10 BA] Ralph Loop: Sidebar patch badge ahora es game-aware — muestra 6.8 en modo WR, 26.8 en modo LoL (antes siempre mostraba 26.8). Build OK. Commit 825c5d1.
- [2026-04-22 04:28 BA] Ralph Loop: Investigación de competencia (10 competidores analizados: OP.GG, U.GG, Mobalytics, Blitz, Porofessor, LoLalytics, iTero, buildzcrank, ProComps, WildRiftFire). 8 ideas nuevas agregadas al tab Ideas: Build Engine contextual, Draft Coach con scoring, Radar chart habilidades, WR Analytics dedicado, Sample size badges, Tier lists comunitarios, Meta Tracker parche a parche, Matchup stats con significancia. App estable — WR color coding y meta overview ya implementados. Build OK. Commit b1409bf.
